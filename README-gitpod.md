...
Using this example in Gitpod connects to the public Solana `devnet` cluster.  Gitpod does not support Docker in Docker so running a local cluster is not supported.  
